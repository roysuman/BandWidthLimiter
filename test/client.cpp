...
int main(int argc, char *argv[])
{
    ...
    std::cout<<"\n Before2 "<<sockfd<<std::endl;
    for( size_t loop_ = 0 ; loop_ < 100 ; ++loop_ ){

    std::string fileName = "/media/roy/7ef2db3a-45a7-43d5-9bad-189a525685f1/example.txt";
